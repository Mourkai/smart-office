<template>
	<view class="signature-wrap" :style="{'display':diaplay}">
		...
		<view v-if="!disabled" v-show="show" class="signature-contain">
			<view class="signature-main" style="z-index: 3000;">
				<view class="signature-btns" style="position: relative;">
					<view class="btn btn-cancel cu-btn bg-main margin-tb-sm text-white" @tap="cancelSignature()">
						<u-icon name="arrow-upward" class="btn1" :style="{'padding-top':(safe.barHeight+10)+'px'}" color="#202024" size="25"></u-icon>
					</view>
					<view class="btn btn-clear cu-btn bg-main margin-tb-sm text-white" style="justify-content: flex-end" @tap="clearSignature();">
						<image src="../../static/public/sign-img-clear.jpg" class="img" :style="{'padding-bottom':(safe.safeBottom+30)+'px'}"></image>
					</view>
					<view class="btn btn-ok cu-btn bg-main margin-tb-sm text-white" style=" height: 0px; justify-content: flex-end" @tap="onOK()">
						<image src="../../static/public/sign-img-ok.jpg" class="img" :style="{'padding-bottom':(safe.safeBottom+30)+'px'}"></image>
					</view>
				</view>
