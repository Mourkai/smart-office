const itemData = [{
		...
		text: ['刘晓丽', '产品经理', '2020-02-091', '技术部', '02-21 20:00'],
		icon: ['account-fill', 'grid-fill', 'calendar', 'bookmark', 'clock-fill'],
		url: '/pages/message/components/wait/waitCommonDetails'
	},
	{
		name: '刘大力',
		rightText: "转正申请",
		...
		rightIcon:"/static/public/zhang.png",
		avatar: 'https://cdn.uviewui.com/uview/album/1.jpg',
		text: ['技术部', '2020-02-09', '2020-02-092', '02-21 20:00'],
		...
		rightIcon:"/static/public/zhang.png",
		avatar: 'https://cdn.uviewui.com/uview/album/1.jpg',
		text: ['刘忠利', '产品部', '技术部', '2020-09-29', '02-21 20:00'],
		...
		rightIcon:"/static/public/zhang.png",
		avatar: 'https://cdn.uviewui.com/uview/album/1.jpg',
		text: ['技术部', '因为个人原因', '2020-02-19','02-21 20:00'],
